      ...
      <div className="no-scrollbar mt-3 flex gap-3 overflow-x-auto px-4 pb-1">
        {loading &&
          Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="h-36 w-48 shrink-0 animate-shimmer rounded-lg border border-tapeLine bg-[linear-gradient(110deg,#1A1620_25%,#241F2D_37%,#1A1620_63%)] bg-[length:200%_100%]"
            />
          ))}
